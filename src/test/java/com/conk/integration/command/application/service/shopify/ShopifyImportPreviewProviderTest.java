...
@DisplayName("ShopifyImportPreviewProvider 테스트")
class ShopifyImportPreviewProviderTest {
    ...
    @InjectMocks
    private ShopifyImportPreviewProvider provider;
    ...
    void preview_usesLatestCreatedAtAsSince() {
        ...
        SellerChannelImportPreviewResponse response = provider.preview(SELLER_ID, request);
    ...
    void preview_usesDefaultSevenDaysWhenSyncWindowUnknown() {
        ...
        provider.preview(SELLER_ID, request);
